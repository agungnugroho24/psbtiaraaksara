...
class Webadmin_model extends Model{
		...
		{
			$q=$this->db->query("select * from tbl_data left join tbl_menu on tbl_data.data_id=tbl_menu.id where tbl_data.data_id!='counter' order by tbl_data.id_data ASC LIMIT 
			$offset,$limit");
			return $q;
		}
