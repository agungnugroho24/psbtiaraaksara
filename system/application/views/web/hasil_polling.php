...
Terimakasih atas partisipasi Anda untuk mengikuti polling kami bulan ini. Tunggu polling-polling selanjutnya di website STIKOM PGRI Banyuwangi.<br /><br />
<?php
...
$gbr = $pr * 1;
echo "<tr><td width='100'>&#8226; <b>".$tmpl_jwb['jawaban']."</b></td><td width='300'><img src='".base_url()."system/application/views/web/images/vote.jpg' width='".$gbr."' height='20'></td><td width='70'>".$pr." %<br></td></tr>";
}
echo '</table>';
