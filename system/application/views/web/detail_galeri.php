...
{
echo "<a href='".base_url()."system/application/views/web/galeri/".$b['foto_besar']."'";
?>
onclick="return hs.expand(this,
			{wrapperClassName: 'borderless floating-caption', dimmingOpacity: 0.75, align: 'center'})"

<?php
echo"><div id='album-besar'><div id='sub-foto'><img src='".base_url()."system/application/views/web/galeri/thumb/".$b['foto_kecil']."' border='0'></div></div></a>";
}
?>
</div>
<br />
