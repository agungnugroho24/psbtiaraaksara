...
<div class="row">
	<div class="col-md-9">
		<div class="page-header" style="height:100px;">
			<h3 class="heading pull-left"><i class="fa fa-list animated bounceIn"></i> Data Pengumuman</h3>
		</div>
	</div>
...
<div class="breadcrumb" style="height:35px;">
	...
	<div class="pull-right" >
		<span style="font-size:18px;">
			<a href="<?php echo base_url()."pengumuman/formeve" ?>">
                <button class="btn btn-info btn-xs" type="button" >
                    <i class="fa  fa-plus-square fa-fw"></i> Add Pengumuman
                </button>
            </a>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php $no=0; foreach ($variable as $key => $value) { $no++; ?>
                                        <tr>
                                            ...
                                            <td> 
                                                <a href="<?php echo base_url()."pengumuman/formeve/".$value["id"] ?>">
                                                        <i class="fa fa-pencil-square" style="cursor:pointer;"></i>
                                                        <span style="font-size:11px;">Edit</span>
                                                </a>
                                                &nbsp;&nbsp;
                                                <a href="<?php echo base_url()."pengumuman/hapus/".$value["id"] ?>"  onClick="return confirm('anda yakin hapus ??');">
