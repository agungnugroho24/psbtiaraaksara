            		...
            		<div class="panel panel-default">
            			...
            			<div class="panel-body">
	            			<form id="validate2" method="POST" action="" novalidate="novalidate" enctype="multipart/form-data" >
                                ...
                                <div class="form-group">
                                    <label>Jenjang :</label>                                        
                                    <input type="text" class="form-control" name="judul" value="<?php echo @$redit[0]["jenjang"] ?>" required/>
                                </div>
								<div class="form-group">
                                    <label>Deskripsi :</label>                                        
                                    	<textarea class="input-block-level" id="summernote" name="content" rows="18" style="width:100%"><?php echo @$redit[0]["deskripsi"] ?></textarea>
                                </div>
	                    ...
	                    <div class="panel-footer clearfix">
							...
							<div class="pull-right" style="margin-right:10px;">                                                                                    
                                <a href="<?php echo base_url()."guru/jenjang/" ?>">
