            		...
            		<div class="panel panel-default">
            			...
            			<div class="panel-body">
	            			<form id="validate2" method="POST" action="" novalidate="novalidate" enctype="multipart/form-data" >
                               ...
                               <div class="form-group">
                                    ...
                                    <select class="form-control" name="kateg" required/>
                                    <?php foreach ($ktg as $key => $kateg) { ?>
                                        <option value="<?php echo @$kateg["id"] ?>" <?php echo $this->allmod->activedata($kateg["id"], @$redit[0]['data_id'],'selected'); ?>><?php echo @$kateg["title"] ?></option>
                                    <?php } ?>
                                    </select>
                                </div>
                                <?php } ?>
	                    ...
	                    <div class="panel-footer clearfix">
							...
							<div class="pull-right" style="margin-right:10px;">                                                                                    
                                <a href="<?php echo base_url()."v/pg/".@$idpg ?>">
